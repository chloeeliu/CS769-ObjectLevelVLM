    ...
    if args.train:
        ...
        with torch.no_grad():
            for i, batch in enumerate(tqdm(train_loader)):
                ...
                # The above code is a Python comment. Comments in Python start with the `#` symbol and
                # are used to provide explanations or notes within the code. Comments are ignored by
                # the Python interpreter and are not executed as part of the program.
                questions = batch['question']
                answers = batch['answer']
