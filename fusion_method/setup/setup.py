...
"""
subprocess.run(["curl", "-O", "http://images.cocodataset.org/zips/train2017.zip"])
# Object Classification Data
subprocess.run(["curl", "-O",  "http://images.cocodataset.org/zips/train2017.zip"])
subprocess.run(["curl", "-O", "http://images.cocodataset.org/zips/val2017.zip"])
subprocess.run(["curl", "-O", "http://images.cocodataset.org/annotations/annotations_trainval2017.zip"])
...
subprocess.run(["curl", "-O",  "https://bvisionweb1.cs.unc.edu/licheng/referit/data/refcocog.zip"])
